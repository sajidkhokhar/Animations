...
| `StretchableHeader`        | You can apply Custom StretchableHeader to your views. | ![customOffset](https://github.com/sajidkhokhar/Animations/blob/main/images/customOffset.gif) |
