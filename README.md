...
| `fromRight, fromBottom, fromBottom, center(scale:fade:)`                | Slide from right with subtle scale and fade | ![fromRight](https://github.com/sajidkhokhar/Animations/blob/main/AnimationResources/fromRight_and_center.gif) |
