...
|----------------------------|-------------|-------------------|
| `All Animations`        | You can apply All Combined animations to your views using single line on each view. | ![Example app]([https://github.com/sajidkhokhar/Animations/blob/main/AnimationResources/StretchableHeader.gif](https://github.com/sajidkhokhar/Animations/blob/main/AnimationResources/ExamplesApp.gif)) |
